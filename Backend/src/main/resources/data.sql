...
('Nesto', 18, 1, 1, 1, 1, 20000, 5, 120, 2, 10, 108, null, 0.0);

INSERT INTO ENDUSER_RENTED(endentity_id, ad_id) VALUES (1, 1);

insert into booking_request(id, group_id, state_of_request, time_from, time_to, together, user_for_id, user_to_id, advertisement_id)
values (1, null, 0, date('2020-06-20 10:14:57'), date('2020-06-24 10:14:57'), false, 2, 3, 1);
